...
module Teek
  module SDL
    ...
    #
    # ```
    # app = Teek::App.new(title: "game")
    # app.show
    # viewport = Teek::SDL::Viewport.new(app, width: 640, height: 480)
    # ```
    #
    ...
    class Viewport
      ...
      def self.ensure_video(app : Teek::App) : Nil
      ...
      # frames does not.
      def initialize(@app : Teek::App, parent : String? = nil,
      ...
      # belongs to whatever owns the application. See Teek::SDL.quit for
      ...
      private def create_window(handle : Teek::NativeWindow) : LibSDL::Window*
