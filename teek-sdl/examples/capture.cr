# Recording the mix.
#
#   cd teek-sdl && crystal run examples/capture.cr
#
...
wav = File.join(Dir.tempdir, "teek-sdl-capture-demo.wav")

mixer = Teek::SDL::Mixer.new
effect = Teek::SDL::Sound.new(blip, mixer)
music = Teek::SDL::Music.new(bed, mixer)
