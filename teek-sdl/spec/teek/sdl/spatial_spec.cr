...
describe "placing a track in space" do
  ...
  describe "#position_3d" do
    it "is the origin before anything places the track" do
      with_mixer do |mixer|
        track = Teek::SDL::Track.new(mixer)
        begin
          track.position_3d.should eq(Teek::SDL::Point3D.new)
        ensure
          track.destroy
        end
      end
    ...
    it "remembers where the track was put" do
      with_mixer do |mixer|
        ...
        track = sound.play_track
        begin
          track.position_3d = Teek::SDL::Point3D.new(x: 3, y: -1, z: 2)
          track.position_3d.should eq(Teek::SDL::Point3D.new(x: 3, y: -1, z: 2))
        ensure
          track.destroy
          sound.destroy
        end
    ...
    it "puts a sound on the side it was placed" do
      with_mixer do |mixer|
        ...
        begin
          ...
          track.position_3d = Teek::SDL::Point3D.new(x: 1, y: 0, z: 0)
          mixed = mixer.generate(256)
    ...
    it "gets quieter the further away it is put" do
      with_mixer do |mixer|
        ...
        begin
          ...
          track.position_3d = Teek::SDL::Point3D.new(x: 50, y: 0, z: 0)
    ...
    it "is reset to the origin by switching to forced stereo" do
      with_mixer do |mixer|
        ...
        track = sound.play_track
        begin
          track.position_3d = Teek::SDL::Point3D.new(x: 5, y: 0, z: 0)
