...
#
# tk_command: is documentary only here - create_menu_tree calls the real
# "menu" Tk command directly, never the generic tk_command_for path
# custom_create: bypasses. arranged: false since a menu_bar attaches via
# its parent's own -menu option, not pack/grid.
