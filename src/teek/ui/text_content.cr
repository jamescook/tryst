...
module Teek
  module UI
    ...
    class TextContent
      ...
      # Wired through `tag bind` rather than a raw tcl_eval, so teek's own
      ...
      # raw Teek::Photo both work - what Tk needs is the Tcl image name
      # either one is named by.
      def insert_image(index : Index, image : Image | Teek::Photo | String) : Nil
        mutate do
      ...
      def image_create(index : Index, image : Image | Teek::Photo | String) : Nil
