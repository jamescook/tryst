...
module Teek
  module UI
    # The exact subset of Teek::App's surface Realizer (and, later,
    ...
    # stand in for a real Teek::App with zero Tk interpreter involved.
    # Included by both the real Teek::App (reopened below) and FakeApp.
    #
    # This doubles as the compile-time equivalent of ruby-teek's
    ...
    # arg, or a dropped method all fail to compile). If Teek::App's real
    ...
    # The exact subset of Teek::Window's surface FakeWindow needs to stay
