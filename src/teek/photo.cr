...
lib LibTk
  ...
  # what makes a non-RGBA source layout (see Teek::PixelFormat) free -
...
module Teek
  ...
  class Interp
    ...
    #
    # Called via Teek::Photo, which is the intended entry point - these
  ...
  class Photo
    ...
    #
    # There's no unpack: option, unlike ruby-teek's: it exists there to
