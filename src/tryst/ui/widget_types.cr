...
module Tryst
  module UI
    ...
    # Tryst::CommandInterceptors's own register/for_type shape - one
    ...
    #
    # ruby-tryst's version also offers .on_register (subscribe to every
...
# ruby-tryst's own require_relative list at the bottom of this same file,
...
require "./widget_types/divider"
require "./widget_types/progress"
require "./widget_types/dropdown"
require "./widget_types/number_box"
