require "../spec_helper"
require "../../src/teek/callback_registry"

# Pure-logic tests for Teek::CallbackRegistry - no Tk interpreter needed
# (precedent: ruby-teek's test/test_callback_registry.rb, which this
# mirrors 1:1). A fake app stub stands in for the real Teek::App, since
...
describe Teek::CallbackRegistry do
