...
require "../../../src/tryst/ui/overlay_validator"
require "../../../src/tryst/ui/validator"
# See handle_spec.cr's own note on requiring the real Realizer.
require "../../../src/tryst/ui/realizer"

# Pure-logic tests for Tryst::UI::OverlayValidator - no Tk interpreter
# needed. Mirrors the overlay-specific case of ruby-tryst's
# tryst-ui/test/test_validator.rb (test_stray_overlay_intent_under_a_non_canvas_parent_raises);
...
describe Tryst::UI::OverlayValidator do
  it "reports an overlay position whose parent isn't a canvas" do
    ...
    errors = [] of String
    Tryst::UI::OverlayValidator.check_stray_overlay(stray, panel, errors)
  ...
  it "says nothing when the parent IS a canvas" do
    ...
    errors = [] of String
    Tryst::UI::OverlayValidator.check_stray_overlay(placed, canvas, errors)
  ...
  it "says nothing for a node with no overlay anchor at all" do
    ...
    errors = [] of String
    Tryst::UI::OverlayValidator.check_stray_overlay(node, nil, errors)
